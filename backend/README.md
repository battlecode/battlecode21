...
Note in particular that `psycopg2` is fixed at 2.7.7. This prevents a bug, in which `psycopg2` requires a working build environmment for the included C code.
