...
export const SERVER_MAPS: Map<string, MapType> = new Map<string, MapType>([
  ...
  ["Andromeda.map21", MapType.SPRINT_1],
  ["Arena.map21", MapType.SPRINT_1],
  ["Bog.map21", MapType.SPRINT_1],
  ["Branches.map21", MapType.SPRINT_1],
  ["Chevron.map21", MapType.SPRINT_1],
  ["Corridor.map21", MapType.SPRINT_1],
  ["Cow.map21", MapType.SPRINT_1],
  ["CrossStitch.map21", MapType.SPRINT_1],
  ["CrownJewels.map21", MapType.SPRINT_1],
  ["ExesAndOhs.map21", MapType.SPRINT_1],
  ["FiveOfHearts.map21", MapType.SPRINT_1],
  ["Gridlock.map21", MapType.SPRINT_1],
  ["Illusion.map21", MapType.SPRINT_1],
  ["NotAPuzzle.map21", MapType.SPRINT_1],
  ["Rainbow.map21", MapType.SPRINT_1],
  ["SlowMusic.map21", MapType.SPRINT_1],
  ["Snowflake.map21", MapType.SPRINT_1]
]);
