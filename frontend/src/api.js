...
class Api {
  ...
  static getNextTournament(callback) {
    ...
    callback({
      "est_date_str": '7 PM EST on January 27, 2020',
      "seconds_until": (Date.parse(new Date('January 27, 2020 19:00:00')) - Date.parse(new Date())) / 1000,
      "tournament_name": "US Qualifying Tournament"
    });
    // callback({
