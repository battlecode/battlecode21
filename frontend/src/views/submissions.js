            ...
            return (
                <div className="card">
                    ...
                    <div className="content">
                        {/* <p>
                            <b>The deadline for the Seeding tournament is 7 pm EST on Monday 1/20 (which is s o o n). Submit your code using the button below. <span style={{textTransform: 'uppercase'}}>Make sure you have filled out the eligibility information at <NavLink to='team'>the team page</NavLink>.</span></b> For peace of mind, submit 15 minutes before and make sure it compiles and shows up 
