...
"""Generate pk and name txts from csv and sort by challonge seeding"""
...
with open(sys.argv[1], 'r') as f:
    ...
    for line in f.readlines():
        ...
        team_seed = seeded[team_name] # Get seed from challonge response dict
